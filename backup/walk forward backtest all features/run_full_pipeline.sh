...
echo "--------------------------------------------------------------------------------"
python "$SCRIPT_DIR/4_compute_forward_alpha_proper_allfeatures.py"

# Step 5
echo ""
echo "STEP 5/6: Precomputing feature-alpha matrix..."
echo "--------------------------------------------------------------------------------"
python "$SCRIPT_DIR/5_precompute_feature_alpha_proper_allfeatures.py"

# Step 6
echo ""
echo "STEP 6/6: Precomputing MC hitrates..."
echo "--------------------------------------------------------------------------------"
python "$SCRIPT_DIR/6_precompute_mc_hitrates_proper_allfeatures.py"

# Step 7
echo ""
echo "STEP 6/6: Precomputing MC hitrates..."
echo "--------------------------------------------------------------------------------"
python "$SCRIPT_DIR/bayesian_strategy_proper_allfeatures.py"
